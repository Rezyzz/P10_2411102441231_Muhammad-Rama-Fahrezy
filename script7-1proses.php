...
<body>
    ...
    // membaca input bilangan pertama
    $bilangan2 = $_POST['bil2'];
    // membaca input bilangan kedua
    $bilangan3 = $_POST['bil3'];
    // membaca input bilangan ketiga

    // cara ke - 1
    // idenya adalah mencari bilangan x yang terbesar dari bil 1 dan bil2. lalu x dibandingkan dengan
    // bilangan ke-3. Jika x > dari bil 3, maka x adalah max dari semua bilangan.
